...
def update_chart(country_list):
    dff = total_per_million[total_per_million['location'].isin(country_list)]
    fig_chart = px.line(
                data_frame=dff, 
                x='date', 
                y='total_cases_per_million', 
                color='location',
                labels={'total_cases_per_million': '', 'date': ''}, 
                hover_name='location',
                hover_data={'location':False, 'date':True, 'total_cases_per_million':True},

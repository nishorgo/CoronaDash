...
from .daily_vaccinations_per_million_app import app
from .daily_vaccinations_per_million_chart import chart_layout
from .daily_vaccinations_per_million_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Number of daily vaccinations per million', style={'textAlign': 'left'}),
                    app_tabs,

...
app = DjangoDash('Vaccinations', external_stylesheets=[dbc.themes.BOOTSTRAP])

df = pd.read_csv('owid-covid-data.csv')
df = df[['location', 'new_vaccinations', 'new_vaccinations_smoothed_per_million', 'total_vaccinations', 'total_vaccinations_per_hundred', 
         'total_boosters', 'total_boosters_per_hundred', 'date']].copy()
...
def update_graph(rows):
    ...
    return html.Div(
        [
            ...
            for column in ['new_vaccinations', 'new_vaccinations_per_million', 'total_vaccinations', 

...
from .total_boosters_per_hundred_app import app
from .total_boosters_per_hundred_chart import chart_layout
from .total_boosters_per_hundred_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Number of total booster doses per hundred', style={'textAlign': 'left'}),
                    app_tabs,

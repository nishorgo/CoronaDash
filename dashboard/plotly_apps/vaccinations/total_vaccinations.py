...
from .total_vaccinations_app import app
from .total_vaccinations_chart import chart_layout
from .total_vaccinations_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Number of total vaccinations', style={'textAlign': 'left'}),
                    app_tabs,

...
from .daily_tests_app import app
from .daily_tests_chart import chart_layout
from .daily_tests_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Daily COVID-19 tests performed each day', style={'textAlign': 'left'}),
                    app_tabs,

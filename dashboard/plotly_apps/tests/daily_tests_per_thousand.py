...
from .daily_tests_per_thousand_app import app
from .daily_tests_per_thousand_chart import chart_layout
from .daily_tests_per_thousand_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Daily COVID-19 tests per thousand people performed each day', style={'textAlign': 'left'}),
                    app_tabs,

...
from .total_tests_app import app
from .total_tests_chart import chart_layout
from .total_tests_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Total COVID-19 tests performed', style={'textAlign': 'left'}),
                    app_tabs,

...
from .positive_rate_app import app
from .positive_rate_chart import chart_layout
from .positive_rate_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('The share of COVID-19 tests that are positive', style={'textAlign': 'left'}),
                    app_tabs,

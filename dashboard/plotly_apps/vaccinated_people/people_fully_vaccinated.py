...
from .people_fully_vaccinated_app import app
from .people_fully_vaccinated_chart import chart_layout
from .people_fully_vaccinated_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Measures of Fully Vaccinated People', style={'textAlign': 'left'}),
                    app_tabs,

...
from .daily_vaccinated_per_hundred_app import app
from .daily_vaccinated_per_hundred_chart import chart_layout
from .daily_vaccinated_per_hundred_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Daily number of vaccinated people per hundred', style={'textAlign': 'left'}),
                    app_tabs,

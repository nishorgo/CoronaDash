...
from .weekly_hosp_admissions_app import app
from .weekly_hosp_admissions_chart import chart_layout
from .weekly_hosp_admissions_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Weekly new hospital admissions for COVID-19', style={'textAlign': 'left'}),
                    app_tabs,

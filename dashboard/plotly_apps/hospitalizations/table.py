...
app = DjangoDash('Hospitalizations', external_stylesheets=[dbc.themes.BOOTSTRAP])

df = pd.read_csv('owid-covid-data.csv')
df = df[['location', 'icu_patients', 'icu_patients_per_million', 'hosp_patients', 'hosp_patients_per_million', 
         'weekly_icu_admissions', 'weekly_hosp_admissions', 'date']].copy()
...
def update_graph(rows):
    ...
    return html.Div(
        [
            ...
            for column in ['icu_patients', 'icu_patients_per_million', 'hosp_patients', 'hosp_patients_per_million', 

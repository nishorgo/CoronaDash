...
from .total_deaths_app import app
from .total_deaths_chart import chart_layout
from .total_deaths_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Cumulative confirmed COVID-19 deaths', style={'textAlign': 'left'}),
                    app_tabs,

...
df = pd.read_csv('dataset/cases_table.csv')
...
df = pd.read_csv('dataset/deaths_table.csv')
...
def update_graph(rows):
    ...
    return html.Div(
        [
            ...
            for column in ['new_deaths', 'new_deaths_per_million', 'total_deaths', 'total_deaths_per_million']
        ]
    )

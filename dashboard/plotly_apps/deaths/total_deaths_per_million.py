...
from .total_deaths_per_million_app import app
from .total_deaths_per_million_chart import chart_layout
from .total_deaths_per_million_map import map_layout
...
app.layout = html.Div(className='w-75 mb-3', children=
    [
        dbc.Card(
            dbc.CardBody(
                [
                    html.H1('Cumulative confirmed COVID-19 deaths per million people', style={'textAlign': 'left'}),
                    app_tabs,
